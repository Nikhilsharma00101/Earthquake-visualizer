...
export default function MapView({ earthquakes }: MapViewProps) {
  const heatmapPoints = earthquakes.map((quake) => {
  ...
  return (
    <div className="relative w-full h-[85vh] rounded-3xl overflow-hidden shadow-2xl border border-gray-200 dark:border-gray-700 bg-gradient-to-br from-gray-100 to-gray-200 dark:from-[#1b1b1b] dark:to-[#121212]">
       {/* 🧭 Magnitude Meter */}
    <div className="absolute top-4 left-4 z-[1000] bg-white/40 backdrop-blur-md rounded-xl shadow-md px-4 py-2 border border-white/30">
      <p className="text-xs font-semibold text-gray-800 mb-1">Magnitude Intensity</p>
      <div className="relative w-40 h-3 rounded-full overflow-hidden">
      ...
      >
        ...
        {/* LayersControl with custom style */}
        <motion.div
